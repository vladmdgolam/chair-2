...
function t396_updateTNobj() {
  ...
  /* window.tn.window_width = parseInt($(window).width()); */ window.tn.window_height = parseInt(
    $(window).height()
  )
...
function t396_artboard_build(data, recid) {
  ...
  tn_console(data)
  /* set style to artboard */ var ab = $("#rec" + recid).find(".t396__artboard")
  t396_ab__renderView(ab)
  /* create elements */ ab.find(".tn-elem").each(function () {
    var item = $(this)
...
function t396_addText(ab, el) {
  ...
  /* add data atributes */ var fields_str =
  ...
  /* render elem view */ t396_elem__renderView(el)
}
...
function t396_addShape(ab, el) {
  ...
  /* add data atributes */ var fields_str = "width,height,top,left,"
  fields_str +=
...
function t396_addVideo(ab, el) {
  ...
  if (typeof viyid != "undefined" && viyid != "") {
    ...
    if (vihascover == "y") {
      url += "&autoplay=1"
      viel.html(
        '<iframe id="youtubeiframe" width="100%" height="100%" data-original="' +
          url +
...
function t396_addForm(ab, el) {
  ...
  /* add data atributes */ var fields_str = "width,top,left,"
...
function t396_elem__renderView(el) {
  ...
  fields = fields.split(",")
  /* set to element value of every fieldvia css */ for (
    var i = 0;
    i < fields.length;
    i++
  ) {
...
function t396_elem__renderViewOneField(el, field) {
  ...
  if (field == "width") {
    ...
    if (eltype == "tooltip") {
      ...
      /*add width to svg nearest parent to fix InternerExplorer problem*/ if (
        pinSvgIcon.length > 0
      ) {
...
function t396_elem__convertPosition__Local__toAbsolute(el, field, value) {
  ...
  if (field == "left") {
    ...
    /* fluid or not*/ var el_leftunits = t396_elem__getFieldValue(
      el,
      "leftunits"
    )
    if (el_leftunits == "%") {
  ...
  if (field == "top") {
    ...
    /* fluid or not*/ var el_topunits = t396_elem__getFieldValue(el, "topunits")
    if (el_topunits == "%") {
    ...
    if (el_axisy == "center") {
      /* var el_height=parseFloat(el.innerHeight()); */ el_height = t396_elem__getHeight(
        el
      )
...
function t396_ab__setFieldValue(ab, prop, val, res) {
  /* tn_console('func: ab__setFieldValue '+prop+'='+val);*/ if (res == "")
...
function t396_ab__getHeight(ab, ab_height) {
  ...
  /* get Artboard height (fluid or px) */ var ab_height_vh = t396_ab__getFieldValue(
    ab,
    "height_vh"
  )
  if (ab_height_vh != "") {
...
function t396_hex2rgb(hexStr) {
  /*note: hexStr should be #rrggbb */ var hex = parseInt(
    hexStr.substring(1),
    16
  )
...
function t400_init(recid) {
  ...
  el.find(".t400__submit").click(function () {
    ...
    recids.forEach(function (recid) {
      ...
      el.find(
        ".t-feed, .t-store, .t117, .t121, .t132, .t223, .t226, .t228, .t229, .t230, .t268, .t279, .t341, .t346, .t347, .t349, .t351, .t353, .t384, .t385, .t386, .t396, .t404, .t409, .t410, .t412, .t418, .t422, .t425, .t428, .t433, .t456, .t477, .t478, .t480, .t486, .t498, .t504, .t506, .t509, .t511, .t517, .t518, .t519, .t520, .t532, .t538, .t539, .t544, .t545, .t552, .t554, .t570, .t577, .t592, .t598, .t599, .t601, .t604, .t605, .t609, .t615, .t616, .t650, .t659, .t670, .t675, .t686, .t688, .t694, .t698, .t700, .t726, .t728, .t734, .t738, .t740, .t744, .t754, .t760, .t762, .t764, .t774, .t776, .t778, .t780, .t798, .t799, .t801, .t822, .t826, .t827, .t829, .t842, .t843, .t849, .t850, .t851, .t856, .t858, .t859, .t860, .t902, .t912, .t923, .t937"
...
function t786_copyTypography(recid) {
  ...
  rec
    .find(".t-popup .t786__title")
    .attr("style", t786_removeSizeStyles(titleStyle))
  rec
    .find(".t-popup .t786__descr, .t-popup .t786__text")
    .attr("style", t786_removeSizeStyles(descrStyle))
}
